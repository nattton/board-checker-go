...
func (app *App) Routes() http.Handler {
	...
	router.Handle("/createqr/{data}", http.HandlerFunc(app.CreateQR)).Methods("GET")
	...
	worksheetRouter.Handle("/maps",
		app.RequireLogin(http.HandlerFunc(app.ShowWorksheetMaps))).Methods("GET")
